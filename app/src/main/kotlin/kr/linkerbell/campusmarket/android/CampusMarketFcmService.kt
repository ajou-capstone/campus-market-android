...
class CampusMarketFcmService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        showNotification(
            channelId = getString(kr.linkerbell.boardlink.android.presentation.R.string.channel_community),
            notificationId = message.sentTime.toInt(),
            title = message.notification?.title,
            content = message.notification?.body,
            icon = kr.linkerbell.boardlink.android.presentation.R.drawable.ic_launcher,
            group = null,
            pendingIntent = null,
